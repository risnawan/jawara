...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url()."assets1/";?>plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url()."assets1/";?>plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url()."assets1/";?>plugins/datepicker/datepicker3.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url()."assets1/";?>plugins/daterangepicker/daterangepicker.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>A</b>JWR</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b> JAWARA</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url()?>gambar/<?php echo $this->session->userdata("foto"); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata("nama"); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url()?>gambar/<?php echo $this->session->userdata("foto"); ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo $this->session->userdata("nama"); ?> - <?php echo $this->session->userdata("username"); ?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url()?>index.php/berita"><i class="fa fa-circle-o"></i>Daftar Berita</a></li>
            <li><a href="<?php echo base_url()?>index.php/berita/add"><i class="fa fa-circle-o"></i>Post Berita</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Komentar</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url()?>index.php/komentar"><i class="fa fa-circle-o"></i>Daftar Komentar</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Kampanye</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url()?>index.php/pengguna"><i class="fa fa-circle-o"></i>Daftar Pengguna</a></li>
...
<script src="<?php echo base_url()."assets1/";?>plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url()."assets1/";?>plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo base_url()."assets1/";?>plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo base_url()."assets1/";?>plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url()."assets1/";?>plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url()."assets1/";?>plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
