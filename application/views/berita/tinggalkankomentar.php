...
<form class="form-horizontal" method="post" action="<?php echo base_url()?>halamanberita/tinggalpesan/">
              ...
              <div class="box-body">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-10" style="width:20%">
                    <input type="date" class="form-control" name="tanggal_berita" placeholder="Tanggal Post" value="">
                  </div>
                </div>
            ...
            <!-- /.box-header -->
            			<div class="box-body pad">
                			...
                			<textarea  class="textarea" name="isi_berita" placeholder="Ketik isi berita di sini." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
